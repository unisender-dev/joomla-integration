...
/* Исправление бага с неверной кодировкой, если сайт уже в UTF-8
        ...
        curl_setopt($ch, CURLOPT_URL, 'http://unisender.local:81/ru/api/'.$method.'?format=json');
        $result = curl_exec($ch);
...
/*
        ...
        $result = file_get_contents('http://www.unisender.com/ru/api/' .$method.'?format=json', FALSE, $Context);
*/
        return $result;
    }
